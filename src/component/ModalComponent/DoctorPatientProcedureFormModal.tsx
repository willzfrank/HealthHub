...
const DoctorPatientProcedureFormModal = (props: Props) => {
  return (
    <form>
      ...
      <div className="flex items-center justify-between w-full gap-5 my-10">
        ...
        <button className="w-1/2 rounded-[3px] bg-[#0061FF] opacity-90 py-2.5 px-10">
          <span className="text-[14px] text-white font-bold">SAVE</span>
        </button>
      </div>
    </form>
  )
...
export default DoctorPatientProcedureFormModal
